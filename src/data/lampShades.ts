export const lampShades = {
  ...
  text1:
    'In unserer über 70-jähriger Firmengeschichte ist die Entwicklung und Herstellung von Lampenschirmen eine starke Konstante. Material sowie Arbeitsabläufe werden laufend verbessert. In der Herstellung sind uns beinahe keine Grenzen gesetzt.',
  text2:
    'Jeder Lampenschirm wird gemäss Wunsch des Kunden angefertigt. Um ein perfektes Ergebnis zu erreichen wird jede Komponente individuell zusammengestellt. Die Produktion sowie die Reparatur von Lampenschirmen wird vollumfänglich in unseren Atelierräumen in Goldach vorgenommen. Unser starkes Team fertigt täglich mit viel Herz und Leidenschaft jeden Lampenschirm in Handarbeit an. Perfektion ist unser oberstes Gebot. Kontaktieren Sie uns per Telefon oder E-Mail für eine unverbindliche Beratung!',
  images: [
    {
